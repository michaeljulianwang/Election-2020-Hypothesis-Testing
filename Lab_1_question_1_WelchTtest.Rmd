---
title: 'Lab 1: Question 1: Are Democrats voters older or younger than Republican voters in 2020?'
...
```{r load and clean data, echo=FALSE, include = FALSE, message=FALSE}
