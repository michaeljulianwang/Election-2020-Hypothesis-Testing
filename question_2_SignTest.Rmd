...
For this analysis, we will operationalize a Democratic voter to be whether the respondent had voted, intends to vote, or has a preference for a Democratic presidential candidate in the 2020 election and who intends to vote in the upcoming election. The former field field is a summary field calculated by the ANES based on whether the respondent has voted and, if not, whom they prefer. The latter field indicates whether or not the respondent intends to register for elections for the 2020 election. The combination of which allows us to narrow our scope just to Democratic voters. Further, we will operationalize a respondent's preference for Joe Biden or Kamala Harris with a respective `Feeling Thermometer` where the respondent ranks their feeling on a scale from 0 to 100, where responses greater than 50 indicate favorable feelings, less than 50 indicate unfavorable, and 50 being indifferent. 
